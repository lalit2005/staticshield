...
const FrameworkCard: React.FC<FrameworkCardProps> = ({ name, link, img }) => {
  return (
    <NextLink href={link}>
      <div className='max-w-sm px-32 py-4 mx-auto my-3 transition-all duration-300 border border-gray-300 rounded-md shadow-md cursor-pointer hover:shadow-2xl'>
