            ...
            <Tabs initialValue='1'>
              <Tabs.Item
                ...
                <CodeSnippet
                  title='NuxtJS'
                  code={`<script>
									setInterval(()=>{window.staticshieldToken||window.location.replace("https://bit.ly/ss-req-block")},3e3);
export default {
  head() {
    return {
